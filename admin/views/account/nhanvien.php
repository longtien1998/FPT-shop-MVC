                                    ...
                                    foreach ($data as $key) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="mx-2 chucnang" href="index.php?accountNhanvienupdate&<?php echo $key['email']; ?>"><i class='text-green bx bx-edit'></i></a>
                                                <a class="mx-2 chucnang xoa" data-toggle="modal" data-target="#exampleModal1" href="index.php?accountNhanviendel&<?php echo $key['email']; ?>"><i class='text-danger bx bxs-trash'></i></a>
