                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header row align-items-center justify-content-between m-0">
                            <h3 class="card-title col m-0">Danh sách nhân viên
                            </h3>
                            <div class="col">
                                <a href="index.php?accountNhanvienadd" class=" btn btn-primary float-right">+ Add nhân viên</a>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $key) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo isset($key['roles']) ?
                                                    ($key['roles'] == 1 ? "<span class='badge badge-danger'>Admin</span>" : ($key['roles'] == 0 ? "<span class='badge badge-primary'>Nhân Viên</span>" :
                                                            "<span class=' badge badge-success'>Khách hàng</span>")) : ""; ?></td>
                                            <td><?php echo $key['soDienThoai']; ?></td>
                                            <td>
                                                <!-- <a class="mx-2 chucnang infoshow" data-index="<?php // echo $i-1;
                                                                                                    ?>" data-toggle="modal" data-target="#exampleModal2" href="" role="button"><i class=" text-warning fa fa-eye"></i></a>
                                                <a class="mx-2 chucnang" href="index.php?accountNhanvienupdate&<?php //echo $key['email']; 
                                                                                                                ?>"><i class='text-green bx bx-edit'></i></a> -->
                                                <a class="mx-2 chucnang xoa <?php echo $key['email'] == $_SESSION["email-admin"] ? "d-none" : "" ;?>" data-toggle="modal" data-target="#exampleModal1" href="index.php?accountNhanviendel&<?php echo $key['email']; ?>"><i class='text-danger text-bg- bx bxs-trash'></i></a>
