    ...
    <div class="container ">
        ...
        <div class="path ">
            <ul class="row list-unstyled m-0">
                ...
                <li><i class='bx bxs-chevron-right'></i></li>
                <li><a class="text-decoration-none" href="index.php?usersregister"><i class='bx bx-user-plus'></i> Quên mật khẩu</a></li>
            </ul>
        </div>
        <div class="login-form w3_form">
            <div class="login w3_login" >
                ...
                <div class="w3l_grid">
                    <form class="login-container" action="index.php?checkemail" method="post">
